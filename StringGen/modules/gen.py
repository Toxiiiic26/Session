...
async def gen_session(
    ...
    await message.reply_text(f"╮⦿ محاولة بدء توكسي بستخراج\n╯⦿ جلسه : {ty}  لك")
    ...
    try:
        ...
        await Anony.send_message(
            chat_id=user_id,
            text=f"𝐒𝐨𝐮𝐑𝐜𝐞𝐓𝐨𝐱𝐢𝐂\n╮⦿ شكرا لك عزيزي لثقتك بتوكسي\n╯⦿ هذه هيا جلستك {ty} \n╮⦿ تم ارسلها لك في رسائل المحفوظه\n╯⦿ ولا تنسي الانضمام <a href={SUPPORT_CHAT}> توكسي ميوزك",
